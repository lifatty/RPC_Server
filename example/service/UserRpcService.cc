/*
 * @Author: YourName
 * @Date: 2024-09-21 10:41:36
 * @LastEditTime: 2024-09-22 17:43:36
 * @LastEditors: YourName
 * @Description: 
 * @FilePath: \mpzRPC-master\mpzRPC-master\example\service\UserRpcService.cc
 * 版权声明
 */
#include <iostream>
...
{
    MpzrpcApplication::init(argc, argv); //读取配置文件并加载
